...
{#if !$selectedAwsProfile}
  {#await awsProfiles then profiles}
    <Modal>
      <div
        class="bg-aria-green pl-3 pr-24 pt-3 pb-1 shadow rounded-t-lg"
      >
        <p class="font-aria-baloo text-aria-grey text-2xl font-light">AWS Account</p>
      </div>
      <div class="p-5 text-aria-green">
      <select class="bg-aria-grey" on:change={chooseProfile}>
